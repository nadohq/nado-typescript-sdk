...
/**
 * Error thrown when the Mobile Identity API returns a failure envelope, either as a non-2xx HTTP response
...
export class MobileServerFailureError extends Error {
  ...
  /**
   * Numeric Mobile Identity API error code, see {@link MOBILE_ERROR_CODE}.
   */
